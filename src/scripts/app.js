...
$containerImperial.isotope({
  ...
  getSortData: {
    ...
    shapes: '.shapes parseInt',
    articlelength: '.articlelength parseInt',
   }
});
$containerOriental.isotope({
  itemSelector: '.nytPhoto',
  layoutMode: 'masonry',
  getSortData: {
    saturation: '.saturation parseInt',
...
$('#sorts').on( 'click', 'button', function() {
    ...
    $containerImperial.isotope({ sortBy: sortValue });
});
$('#sorts').on( 'click', 'button', function() {
    var sortValue = $(this).attr('data-sort-value');
    $containerOriental.isotope({ sortBy: sortValue });
});
// Every day im shufflin tududutudud
$('.shuffle-button').on( 'click', function() {
    $containerOriental.isotope('shuffle'); 
    $containerImperial.isotope('shuffle');
});

// LAYOUT
// FUNCTION TO REPOSITION ELEMENTS    
var isotopeReinit = function reinitIso() {
...
// remove shadows
$(function(){
    $(document).on('click','#cleangui',function(){
        if($(this).prop('checked')) {
            $(".shadowgradiant").css( "display", "block" );
        } else {
            $(".shadowgradiant").css( "display", "none" );
        }
    });
});
...
$(function(){
    $(document).on('click','#removelabel',function(){
        if($(this).prop('checked')) {
            $(".countrytag").css( "display", "block" );
        } else {
            $(".countrytag").css( "display", "none" );
        }
    });
});
...
// Nice list of filters: 
// ...

// I would say copy out what you need from the stuff below, and delete the unneeded rest.
// Btw. You dont need to create the container variable everytime. The two vars on top are in the global scope. 
...
//     // KLIK VOOR GROOT
//     // $container.on( 'click', '.nytPhoto', function() {
//     //   $(this).toggleClass('groter');
//     //   $container.isotope('layout');
//     // });
...
//         var ul = $("#imperialcountry");
//         var items = ul.find(".fluid");
//         var number = items.length;
//         var random = Math.floor((Math.random() * number));
//         items.eq(random).addClass("gone");
//     }
...
//     $(document).ready(function() {
//                     $(".nytTimestamp").text(function(index, currentText) {
...
$( "#imperialcountry" ).resizable({
        ...
        stop: function() {
            ...
            $containertwo.isotope('layout');
=======
//     // setTimeout(function() {$("#fiftyFifty").trigger("click");}, 2000);
